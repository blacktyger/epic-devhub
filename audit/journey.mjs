...
notes.push('');
notes.push(
  `Generated by \`npm run journey\` in \`epic-devdocs/audit\` on ${summary.capturedAt}. One reader, no prior Epic knowledge, following the route the site itself declares in \`site/src/data/developerJourney.js\`.`,
);
notes.push('');
notes.push(
