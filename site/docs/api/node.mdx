...
both, and the table below maps each route onto its method.
...
The router registers 19 patterns, three of them wildcards. The concrete forms are below.
...
A call against a node with no `api_secret` set:
