...
```python title="examples/python/epic_wallet.py" file=<rootDir>/examples/python/epic_wallet.py#L27-L60
```
...
```python title="examples/python/send.py" file=<rootDir>/examples/python/send.py#L28-L55
```
...
```python title="examples/python/send.py" file=<rootDir>/examples/python/send.py#L16-L25
```
...
```python title="examples/python/receive.py" file=<rootDir>/examples/python/receive.py#L20-L46
```
...
```python title="examples/python/clear_stuck.py" file=<rootDir>/examples/python/clear_stuck.py#L15-L34
```
