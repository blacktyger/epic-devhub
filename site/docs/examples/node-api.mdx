...
- **The double envelope.** A response has a JSON-RPC `result`, and inside it an `Ok` or `Err`. See
  [the response envelope](/api#the-response-envelope).
...
## Watch for new blocks {/* #watch-for-new-blocks */}
...
## Mempool and peers {/* #mempool-and-peers */}
...
### Every other method {/* #every-other-method */}
